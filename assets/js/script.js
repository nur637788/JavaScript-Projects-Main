...
fetch('./assets/js/projects.json')
    ...
    .then(projects => {
        ...
        projects.forEach(proj => {
            // live & code fallback (যদি কোনোটা না থাকে)
            const liveLink = proj.live ? proj.live : `projects/${proj.meta}`;
            const codeLink = proj.code ? proj.code : `https://github.com/nur637788/Color-Generate/${proj.meta}`;

            project += `
    <div class="box">
        <img src="./assets/projects-img/${proj.meta}.png" alt="${proj.name}">
        <div class="content">
            <h3>${proj.name}</h3>
            <p>${proj.desc}</p>
            <div class="btns">
